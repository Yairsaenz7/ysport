//close collapse menu on option selection
...
$("#home").click(function () {
  $('html,body').animate({
      scrollTop: $(".full-page-intro").offset().top
    },
    'slow');
});


//scroll to section on menu a click
$(".menu-item").click(function () {
  var menuItem = $(this).attr("id");

  //set highlight class on menu click
  ...
  if (menuItem === "about")
    $("#aboutNavMenu").addClass("active");

  if (menuItem != "home")
    $('html,body').animate({
        scrollTop: $("#" + menuItem + "-section").offset().top - 90
      },
      'slow');
});
